              ...
              <div class="row">
                <div class="col-md-6 col-lg-3">
                  <div class="item wow inShow" data-wow-delay="0.45s">
                    <P>年龄 : <span>{{calcDate(userInfo.birthday)}}</span></P>
                  </div>
                </div>
                <div class="col-md-6 col-lg-3">
                  <a class="item wow inShow" data-wow-delay="0.55s" :href="userInfo.website" target="_blank">
                    <P>工作经验 : <span>{{userInfo.workages}}年</span></P>
                  </a>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-lg-3">
                  <div class="item wow inShow" data-wow-delay="0.3s">
                    <P>专业 : <span>{{userInfo.professional}}</span></P>
                  </div>
                </div>
                <!-- <div class="col-md-6 col-lg-3">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="item wow inShow" data-wow-delay="0.65s">
                    <p>QQ : <span>{{userInfo.qq.number}}</span></p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-lg-6">
                  <div class="item wow inShow" data-wow-delay="0.65s">
                    <p>个人邮箱 : <span>wangxiang8192@163.com</span></p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-lg-6">
                  <a class="item wow inShow" data-wow-delay="0.7s" :href="userInfo.website" target="_blank">
                    <p>个人网站 : <span>{{userInfo.website}}</span></p>
                  </a>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-lg-6">
                  <a class="item wow inShow" data-wow-delay="0.75s" :href="userInfo.github" target="_blank">
                    <p>Github : <span>{{userInfo.github}}</span></p>
                  </a>
                </div>
              </div>
            </div>
